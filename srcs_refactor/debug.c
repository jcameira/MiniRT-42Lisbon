...
void	print_parsed_elements(t_scene scene)
{
	...
	while (tmp)
	{
		printf("Origin -> %f,%f,%f\n", ((t_light *)tmp->content)->f.sp.c[x], ((t_light *)tmp->content)->f.sp.c[y], ((t_light *)tmp->content)->f.sp.c[z]);
		printf("Brithness -> %f\n", ((t_light *)tmp->content)->br);
		printf("Color -> %d,%d,%d\n", ((t_light *)tmp->content)->c.r, ((t_light *)tmp->content)->c.g, ((t_light *)tmp->content)->c.b);
		printf("\n");
		tmp = tmp->next;
	}
	printf("===============OBJECTS==============\n");
